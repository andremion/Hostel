...
@Module
internal class TestDataModule(private val baseUrl: String) {

    @Provides
    @Singleton
    internal fun provideHostelService(): HostelService = HostelApi(baseUrl)
    ...
    internal fun provideLocalDatabase(context: Context): LocalDatabase {
        return TestDatabase.newInstance(context)
    }
